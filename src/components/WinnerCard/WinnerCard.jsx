		...
		<Fragment>
			<div id="winnerScroller" className="animatedReveal winners-campaign-area winners-body">
                ...
                <div className="swiper-wrapper">
						<div
							className="swiper-slide sliderReveal swiper-slide-visible swiper-slide-active"
							role="group"
						>
							...
							<div className="winner-campagin-box">
								<div className="campaign-image">
									<img
										src="https://www.idealz.com/on/demandware.static/-/Sites-idealz-master-catalog/default/dw19f8b772/images/campaignsliderimage/CG-03269_dashboard_image1.png"
										alt="[[PrizeValue]] Cash winnerProfilePic"
										className="combineImage lozad"
										data-loaded="true"
									/>
								</div>
