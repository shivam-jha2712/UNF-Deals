...
{/* Social Icons */}
              <div className="social-navigation">
                <a href="https://www.facebook.com/idealzworld" className="social-link facebook">
                  <FaFacebook className="social-icon" />
                </a>
                <a href="https://twitter.com/idealz" className="social-link twitter">
                  <FaTwitter className="social-icon" />
                </a>
                <a href="https://www.linkedin.com/company/idealz-enterprises-llc" className="social-link linkedin">
                  <FaLinkedin className="social-icon" />
                </a>
                <a href="https://www.instagram.com/idealz/" className="social-link instagram">
                  <FaInstagram className="social-icon" />
                </a>
                <a href="https://wa.me/97143551888" className="social-link whatsapp">
                  <FaWhatsapp className="social-icon" />
                </a>
                <a href="https://www.tiktok.com/@idealz" className="social-link tiktok">
...
{/*
             ...
             <li><a href="https://www.facebook.com/idealzworld/" className="facebook"><svg width="53" height="52" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <ellipse cx="26.5" cy="26" rx="26.5" ry="26" fill="#F3F3F3"></ellipse>
                  <path d="M32.477 26.485H28.62V40h-5.842V26.485H20v-5.11h2.779v-3.307c0-2.365 1.09-6.068 5.894-6.068l4.327.019v4.96h-3.14c-.515 0-1.239.265-1.239 1.393v3.008h4.366l-.51 5.105z" fill="#696969"></path></svg></a></li>
                <li><a href="https://twitter.com/idealz" className="twitter"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
