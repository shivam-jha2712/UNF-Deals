        ...
        <div id="main-page-slider" className="animatedReveal">
            <div className="swiper-container swiper-container-initialized swiper-container-horizontal">
                ...
                {/* style="transition: all 0ms ease 0s; transform: translate3d(-810px, 0px, 0px);" */}
                    <div className="swiper-slide content-box swiper-slide-prev" role="group" aria-label="1 / 2">
                    ...
                    <div className="swiper-slide content-box swiper-slide-active"role="group" aria-label="2 / 2">
